      ...
      switch (e['data-layout']) {
        ...
        default:
          'vertical' == sessionStorage.getItem('data-layout') && sessionStorage.getItem('data-layout')
            ...
            ? (C('data-layout', 'horizontal'), sessionStorage.setItem('data-layout', 'horizontal'), document.documentElement.setAttribute('data-layout', 'horizontal'), z('horizontal'))
            : 'twocolumn' == sessionStorage.getItem('data-layout') && (C('data-layout', 'twocolumn'), sessionStorage.setItem('data-layout', 'twocolumn'), document.documentElement.setAttribute('data-layout', 'twocolumn'), z('twocolumn'));
      }
      ...
      switch (e['data-sidebar']) {
        ...
        default:
          sessionStorage.getItem('data-sidebar') && 'light' == sessionStorage.getItem('data-sidebar')
            ...
            : 'gradient-4' == sessionStorage.getItem('data-sidebar') && (sessionStorage.setItem('data-sidebar', 'gradient-4'), C('data-sidebar', 'gradient-4'), document.documentElement.setAttribute('data-sidebar', 'gradient-4'));
      }
      switch (e['data-sidebar-image']) {
        ...
        default:
          sessionStorage.getItem('data-sidebar-image') && 'none' == sessionStorage.getItem('data-sidebar-image')
            ...
            : 'img-4' == sessionStorage.getItem('data-sidebar-image') && (sessionStorage.setItem('data-sidebar-image', 'img-4'), C('data-sidebar-image', 'img-4'), document.documentElement.setAttribute('data-sidebar-image', 'img-4'));
      }
